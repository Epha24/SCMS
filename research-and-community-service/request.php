...
<head>
  ...
  <title>Research and Community Service | STBC Student Clearance Management System</title>
        ...
        <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown"><img src="../pic/user.PNG" class="user-image" alt="User Image"></span></a>
          <ul class="dropdown-menu">
            <li class="user-header bg-info">
              ...
              <p><span id="user"><?php echo user(); ?></span> - RCS</p>
            </li>
            <li class="user-body">
              <div class="row">
                <div class="pull-left">
        ...
        <div class="card-header">
            ...
            <table class="table table-bordered table-striped example1">
                ...
                <tbody>
                  <?php
                  $num = 1;
                   $qry = "SELECT student.stud_id, student.fname, student.mname, student.lname, student.user_name, clearance.clearance_id, clearance.req_user, clearance.re_date,clearance.reason, clearance.rcs_app  FROM student JOIN clearance ON student.user_name = clearance.req_user";
                ...
                <tr>
                  ...
                  <td><?php if($row['rcs_app'] == 'Rejected'){echo "<span class='text-danger'>".$row['dean_app']."</span>"; }else{ echo $row['rcs_app']; }?></td>
                 <td><?php if($row['rcs_app'] == 'Pending...'){ ?><a href="../action.php?approve-request-ex-id=<?php echo $row['clearance_id'] ?>"><i class="fa fa-check" style="color: orange;" title="Approve Request"></i></a> &nbsp;&nbsp;&nbsp; | &nbsp;&nbsp;&nbsp;<a href="../action.php?reject-request-ex=<?php echo $row['clearance_id'] ?>"><i class="fa fa-times" style="color: red;" title="Reject Request"></i></a><?php } else{ ?> <a href="#"><i class="fa fa-check" style="color: orange;" title="Already <?php echo $row['rcs_app']; ?>"></i></a> &nbsp;&nbsp;&nbsp; | &nbsp;&nbsp;&nbsp;<a href="#"><i class="fa fa-times" style="color: red;" title="Already <?php echo $row['rcs_app']; ?>"></i></a> <?php } ?></td>
                </tr><?php $num++;
              }?>
                </tbody>
                <tfoot>
