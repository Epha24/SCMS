...
<head>
  ...
  <title>Student Dean | STBC Student Clearance Management System</title>
...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav ml-auto">
      <?php $qry_select = "SELECT *FROM clearance WHERE student_dean_not = '1' AND dep_head_app = 'Approved'";
        ...
        <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown"><img src="../pic/user.PNG" class="user-image" alt="User Image"></span></a>
          <ul class="dropdown-menu">
            <li class="user-header bg-info">
              ...
              <p><span id="user"><?php echo user(); ?></span> - Student Dean</p>
            </li>
            <li class="user-body">
              <div class="row">
                <div class="pull-left">
            ...
            <table class="table table-bordered table-striped example1">
                ...
                <tr>
                 ...
                 <tbody>
                  <?php
                  $num = 1;
                   $qry = "SELECT student.stud_id, student.fname, student.mname, student.lname, student.user_name, student.department, clearance.clearance_id, clearance.req_user, clearance.re_date,clearance.reason, clearance.student_dean_app FROM student JOIN clearance ON student.user_name = clearance.req_user AND clearance.dep_head_app = 'Approved' ORDER BY student_dean_app DESC";
                   $ext = mysqli_query($conn,$qry);

                   while($row = mysqli_fetch_array($ext)){

                  ?>
                <tr <?php if($row['student_dean_app'] == "Pending..."){ echo"style='background-color : orange;'"; } ?>>
                  <td><?php echo $num; ?></td>
                  ...
                  <td><?php if($row['student_dean_app'] == 'Rejected'){echo "<span class='text-danger'>".$row['student_dean_app']."</span>"; }else{ echo $row['student_dean_app']; }?></td>
                 <td><?php if($row['student_dean_app'] == 'Pending...'){ ?><a href="../action.php?approve-request-stud-dean-id=<?php echo $row['clearance_id'] ?>"><i class="fa fa-check" style="color: white;" title="Approve Request"></i></a> &nbsp;&nbsp;&nbsp; | &nbsp;&nbsp;&nbsp;<a href="../action.php?reject-request=<?php echo $row['clearance_id'] ?>"><i class="fa fa-times" style="color: red;" title="Reject Request"></i></a><?php } else{ ?> <a href="#"><i class="fa fa-check" style="color: orange;" title="Already <?php echo $row['student_dean_app']; ?>"></i></a> &nbsp;&nbsp;&nbsp; | &nbsp;&nbsp;&nbsp;<a href="#"><i class="fa fa-times" style="color: red;" title="Already <?php echo $row['student_dean_app']; ?>"></i></a> <?php } ?></td>
                </tr><?php $num++;
              }?>
                </tbody>
                <tfoot>
