...
<head>
  ...
  <link rel="icon" type="image/icon" href="../img/logo.jpg">
...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav ml-auto">
      <?php $qry_select = "SELECT *FROM clearance WHERE dep_head_not = '1'";
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          <a href="request.php?approve-request" class="dropdown-item">
            <i class="fas fa-envelope mr-2"></i> <?php echo $num; ?> Pending Request
          </a>
        </div>
      </li>
      <?php } ?>
        ...
        <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown"><img src="../pic/user.PNG" class="user-image" alt="User Image"></span></a>
          <ul class="dropdown-menu">
            <li class="user-header bg-info">
              ...
              <p><span id="user"><?php echo user(); ?></span> - Department Head</p>
            </li>
            <li class="user-body">
              <div class="row">
                <div class="pull-left">
        ...
        <div class="card-header">
            ...
            <table class="table table-bordered table-striped example1">
                ...
                <tbody>
                  <?php
                  $num = 1;
                   $qry = "SELECT student.stud_id, student.fname, student.mname, student.lname, student.user_name, student.department, clearance.clearance_id, clearance.req_user, clearance.re_date,clearance.reason, clearance.dep_head_app, users.department, users.username  FROM student JOIN clearance JOIN users ON student.user_name = clearance.req_user AND student.department = users.department ORDER BY clearance.dep_head_app DESC";
                   $ext = mysqli_query($conn,$qry);

                   while($row = mysqli_fetch_array($ext)){

                  ?>
                <tr <?php if($row['dep_head_app'] == "Pending..."){ echo"style='background-color : orange;'"; } ?>>
                  <td><?php echo $num; ?></td>
                  ...
                  <td><?php if($row['dep_head_app'] == 'Rejected'){echo "<span class='text-danger'>".$row['dep_head_app']."</span>"; }else{ echo $row['dep_head_app']; }?></td>
                 <td><?php if($row['dep_head_app'] == 'Pending...'){ ?><a href="../action.php?approve-request-head-id=<?php echo $row['clearance_id'] ?>"><i class="fa fa-check" style="color: white;" title="Approve Request"></i></a> &nbsp;&nbsp;&nbsp; | &nbsp;&nbsp;&nbsp;<a href="../action.php?reject-request-head=<?php echo $row['clearance_id'] ?>"><i class="fa fa-times" style="color: red;" title="Reject Request"></i></a><?php } else{ ?> <a href="../action.php?approve-request-head-id=<?php echo $row['clearance_id'] ?>"><i class="fa fa-check" style="color: orange;" title="Already <?php echo $row['dep_head_app']; ?>"></i></a> &nbsp;&nbsp;&nbsp; | &nbsp;&nbsp;&nbsp;<a href="#"><i class="fa fa-times" style="color: red;" title="Already <?php echo $row['dep_head_app']; ?>"></i></a> <?php } ?></td>
                </tr><?php $num++;
              }?>
                </tbody>
                <tfoot>
